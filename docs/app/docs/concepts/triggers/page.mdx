...
<ConfigPanel title="Trigger Example">
  <ConfigField label="Agent" value="Daily Sales Summary" />
  <ConfigField label="Trigger" value="Every day at 9:00 AM" />
  <ConfigField label="Action" value="Generates sales report and sends via email" />
</ConfigPanel>
...
<ConfigPanel title="Trigger Example">
  ...
  <ConfigField label="Trigger" value="After Submit on DocType &quot;Sales Invoice&quot;" />
  <ConfigField label="Action" value="Validates pricing, checks credit limits, flags issues" />
</ConfigPanel>
...
<ConfigPanel title="Trigger Example">
  ...
  <ConfigField label="Schedule" value="Every day at 8:00 AM" />
</ConfigPanel>
...
<ConfigPanel title="Trigger Example">
  <ConfigField label="Agent" value="Lead Qualifier" />
...
<ConfigPanel title="Trigger Example">
  <ConfigField label="Trigger" value="After Insert on Lead" />
...
<ConfigPanel title="Trigger Example">
  <ConfigField label="Trigger" value="On Submit on Sales Invoice" />
  <ConfigField label="Agent" value="Invoice Validator" />
</ConfigPanel>
...
<ConfigPanel title="Trigger Example">
  <ConfigField label="Trigger" value="After Insert on Support Ticket" />
...
**Need help with triggers?** Check [GitHub discussions](https://github.com/tridz-dev/huf/discussions).
