...
<ConfigPanel title="Agent Profile">
  <ConfigField label="Role" value="Customer Support Assistant" />
  <ConfigField label="Purpose" value="Answer customer questions and create support tickets" />
  <ConfigField label="Users" value="End customers and support team" />
  <ConfigField label="Scope" value="FAQ, ticket creation, basic information lookup" />
</ConfigPanel>
